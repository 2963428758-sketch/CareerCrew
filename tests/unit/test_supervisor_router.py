...
def test_build_graph_routes_and_terminates(valid_config_data: dict) -> None:
    ...
    app = build_graph({"career_planner": career_planner, "job_matcher": job_matcher}, checkpointer=None)
    init = {
