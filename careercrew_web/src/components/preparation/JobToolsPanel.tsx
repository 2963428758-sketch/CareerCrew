...
import { Copy, Loader2, ScanSearch, Sparkles } from "lucide-react"

import { Button } from "@/components/ui/button"
import { Badge } from "@/components/ui/badge"
import { networkErrorText } from "@/lib/errors"
import { createApplicationKit, runAtsCheck, type ApplicationKit, type AtsResult } from "@/lib/career"
...
export function JobToolsPanel({ opportunity, onToast }: {
  ...
  const [running, setRunning] = useState<"ats" | "kit" | null>(null)
